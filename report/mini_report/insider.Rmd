...
test -s ../../INSIDER/TE_DETECTION/INSERTION_COUNT_TE.csv && awk -F "\t" 'NR>1 {print $2}' ../../INSIDER/TE_DETECTION/INSERTION_COUNT_TE.csv | tail -n 50 > .tmp_orderc.txt


test -s ../../INSIDER/FREQ_GLOBAL/DEPTH_TE_INSIDER.csv && python3 ../lib/freq_graph.py ../../INSIDER/FREQ_GLOBAL/DEPTH_TE_INSIDER.csv .tmp_FREQ_TE.csv && echo -e "x\ty\tcondition" > FREQ_TE.csv && grep -w -f .tmp_orderc.txt .tmp_FREQ_TE.csv >> FREQ_TE.csv || echo ;
...
orderx <- read.table(".tmp_orderc.txt", header = FALSE)
