...
parser.add_argument("name_instruction", type=str,
                    help="file instruction_file snake file")
...
parser.add_argument("-t", "--name_template", type=str, help="template file conatain additionnel instruction_file python for snakefile")
