...
print("[" + str(sys.argv[0]) + "] keep only TE on list, size :", len(df.values))
...
print("[" + str(sys.argv[0]) + "] size for min_size_percent>=" + str(min_size_percent) + ", min_pident>=" + str(min_pident), len(df.values))
